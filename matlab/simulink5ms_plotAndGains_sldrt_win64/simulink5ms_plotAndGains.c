 ...
 * C source code generated on : Tue Dec 11 12:49:30 2018
 *
...
void simulink5ms_plotAndGains_output(void)
{
  ...
  /* Gain: '<Root>/averaged' incorporates:
   *  DataTypeConversion: '<S1>/Data Type Conversion'
   */
  simulink5ms_plotAndGains_B.averaged = simulink5ms_plotAndGains_P.averaged_Gain
    * (real_T)simulink5ms_plotAndGains_B.PacketInput1_o1[0];

  /* Gain: '<Root>/single_sampling' incorporates:
   *  DataTypeConversion: '<S1>/Data Type Conversion2'
   */
  simulink5ms_plotAndGains_B.single_sampling =
    simulink5ms_plotAndGains_P.single_sampling_Gain * (real_T)
    simulink5ms_plotAndGains_B.PacketInput1_o1[1];
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  rtmSetTFinal(simulink5ms_plotAndGains_M, 35.0);
  simulink5ms_plotAndGains_M->Timing.stepSize0 = 0.005;

  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (2596168716U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (3154926084U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (2063207812U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (1091029343U);
